...
trait GamePackets {
  ...
  val CMSG_INSPECT = 0x3B8
  val SMSG_INSPECT_TALENT = 0x3F4
  val SMSG_NAME_QUERY = 0x51
  val CMSG_GUILD_QUERY = 0x54
  val CMSG_GUILD_INVITE   = 0x082
  val CMSG_GUILD_PROMOTE  = 0x08B
  val CMSG_GUILD_DEMOTE   = 0x08C
  val CMSG_GUILD_KICK     = 0x08E
  val SMSG_GUILD_INVITE = 0x083
  val SMSG_GUILD_COMMAND_RESULT = 0x093
